 ...
 */
public class ServiceActivity extends BaseMvpActivity<IMessgListView, MessgListPresenter> implements IMessgListView {
    ...
    protected int attachLayoutRes() {
        return R.layout.act_base_service_list;
    }
    ...
    private void initRv() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                TeamDetailActivity.start(ServiceActivity.this);
            }
        });
    }
