...
import com.base.kiap.adapter.BaseQuotaHistoryAdapter;
 ...
 */
public class QuotaHistoryActivity extends BaseMvpActivity<IMessgListView, MessgListPresenter> implements IMessgListView {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, QuotaHistoryActivity.class);
        context.startActivity(starter);
    }

    private ActBaseQuotaListBinding binding;

    private BaseQuotaHistoryAdapter adapter;
    private List<MessageBean> mList = new ArrayList<>();

    @Override
    protected int attachLayoutRes() {
        return R.layout.act_base_quota_list;
    }

    @Override
    public View attachLayoutView() {
        binding = ActBaseQuotaListBinding.inflate(getLayoutInflater());
        return binding.getRoot();
    }

    @Override
    protected void initData() {
        tvTitle.setText("Quota History");
        initImmersionBar();
//        showLoading();
    ...
    private void initRv() {
        adapter = new BaseQuotaHistoryAdapter();
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                TeamDetailActivity.start(QuotaHistoryActivity.this);
            }
        });
    }
