 ...
 * @Description: post 支付地址
 */
public class WebActivity2 extends BaseMvpActivity {

    public static final String URLCODE = "url_code";
    public static final String URLCODE2 = "url_params";
    ...
    public static void start(Context context, String url,String params) {
        Intent starter = new Intent(context, WebActivity2.class);
        starter.putExtra(URLCODE, url);
        starter.putExtra(URLCODE2, params);
    ...
    protected void initData() {
        ...
        params = getIntent().getStringExtra(URLCODE2);
        showLoading();
        initWebView();
    }
...
//        String sign = AppUtils.Companion.MD5Sign("amount=10.00&orderid=2019042212547782327&pay=zfb&shid=happyEarn01&url=http://47.116.76.202:8899/getnenePay/callback&key=8CU7KC3OZ7DNWB86CV6VYIFINQ7356FK");
//        String str = "shid=happyEarn01&sign=" + sign +
//                "&orderid=2019042212547782327&amount=10.00&pay=zfb&url=http://47.116.76.202:8899/getnenePay/callback";
        mAgentWeb.getWebCreator().getWebView().postUrl(url,params.getBytes());
